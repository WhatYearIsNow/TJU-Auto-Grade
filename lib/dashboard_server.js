...
const EDITABLE_KEYS = new Set([
  'EAMS_USERNAME', 'EAMS_PASSWORD', 'DASHSCOPE_API_KEY', 'VISION_MODEL',
...
const PUBLIC_SETTING_KEYS = [
  'EAMS_USERNAME', 'VISION_MODEL', 'QQ_EMAIL', 'NOTIFY_EMAIL', 'COMMAND_EMAIL',
...
function setupStatus(env) {
  ...
  return {
    ...
    steps: {
      ...
      aiLogin: { ready: has('DASHSCOPE_API_KEY'), required: false },
    },
  };
}
      ...
      this.sendJson(response, 200, {
        ...
        data: {
          ...
          capabilities: {
            ...
            aiLogin: Boolean(this.env.DASHSCOPE_API_KEY),
